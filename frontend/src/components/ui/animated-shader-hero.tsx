    ...
    useEffect(() => {
        ...
        void main(){gl_Position=position;}`;
            ...
            render(now = 0) {
                ...
                // Fix: Use direct index access [0] and [1] instead of ...spread
      ...
      `}</style>
            ...
            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
                ...
                <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
                    ...
                    {/* Render any children (like Search Bar) */}
                    {children && (
                        <div className="w-full max-w-2xl mx-auto mt-12 animate-fade-in-up animation-delay-800">
                            {children}
                        </div>
                    )}
                </div>
